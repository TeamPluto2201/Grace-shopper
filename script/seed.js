...
async function seed() {
  ...
  const orders = await Promise.all([
   ...
   const orderEntries = await Promise.all([
    ...
    OrderEntry.create({ size: 'M', color: 'black', QTY: 1 }),
    OrderEntry.create({ size: 'S', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 3 }),
    OrderEntry.create({ size: 'M', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'M', color: 'black', QTY: 2 }),
    OrderEntry.create({ size: 'S', color: 'white', QTY: 3 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 1 }),
    OrderEntry.create({ size: 'M', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'M', color: 'black', QTY: 2 }),
    OrderEntry.create({ size: 'S', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 1 }),
    ...
    OrderEntry.create({ size: 'S', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 4 }),
    OrderEntry.create({ size: 'M', color: 'white', QTY: 3 }),
    OrderEntry.create({ size: 'M', color: 'black', QTY: 2 }),
    OrderEntry.create({ size: 'S', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 5 }),
    OrderEntry.create({ size: 'M', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'M', color: 'black', QTY: 2 }),
    OrderEntry.create({ size: 'S', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 4 }),
    OrderEntry.create({ size: 'M', color: 'white', QTY: 7000 }),
    OrderEntry.create({ size: 'M', color: 'black', QTY: 2 }),
    OrderEntry.create({ size: 'S', color: 'white', QTY: 1 }),
    OrderEntry.create({ size: 'L', color: 'black', QTY: 4 }),
    OrderEntry.create({ size: 'M', color: 'white', QTY: 1 }),
